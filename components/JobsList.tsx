...
import PagesButtonContainer from "./PagesButtonContainer";
  ...
  return (
    <>
      <div className='flex items-center justify-between mb-8'>
        ...
        {totalPages < 2 ? null : (
          <PagesButtonContainer currentPage={page} totalPages={totalPages} />
        )}
      </div>
      <div className='grid md:grid-cols-2 grp-8'>
        {jobs.map((job) => {
